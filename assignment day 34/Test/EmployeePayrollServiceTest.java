...
public class EmployeePayrollServiceTest {
    ...
    public void given3Employees_WhenWrittenToFile_ShouldMatchEmployeeEntries() {
        EmployeePayrollData[] arrayOfEmployees = {
                new EmployeePayrollData(1, "Mohd Sohail", 100000.0, LocalDate.now()),
                new EmployeePayrollData(2, "Salman Khan", 200000.0, LocalDate.now()),
                new EmployeePayrollData(3, "Kabeer Khan", 300000.0, LocalDate.now())
        };
